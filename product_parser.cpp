...
{
    Product* new_book = new Book(categoryID(), prodName_, price_, qty_, isbn_, author_);
    return new_book;
...
{
    Product* new_clothing = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
    return new_clothing;
...
{
    Product* new_movie = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
    return new_movie;
